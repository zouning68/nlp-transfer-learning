...
import data
from models.mesh_transformer import mesh_eval_dataset_fn
from models.mesh_transformer import mesh_train_dataset_fn
...
class MtfModel(T5Model):
  ...
  def train(self, mixture_or_task_name, steps, init_checkpoint=None):
    ...
    """
    vocabulary = data.get_mixture_or_task(
  ...
  def predict(self, input_file, output_file, checkpoint_steps=-1,
              ...
              sentencepiece_model_path=data.DEFAULT_SPM_PATH):
    ...
    vocabulary = data.SentencePieceVocabulary(sentencepiece_model_path)

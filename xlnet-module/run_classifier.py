...
'''
# Model
flags.DEFINE_string("model_config_path", default="pretrain_model/config.json",
...
flags.DEFINE_string("spiece_model_file", default="token_model/chinese/spiece.model",
      help="Sentence Piece model path.")
flags.DEFINE_string("model_dir", default="finetuning_model/imdb",
...
flags.DEFINE_integer("save_steps", default=10,

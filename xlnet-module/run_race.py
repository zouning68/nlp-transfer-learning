...
'''
# Model
flags.DEFINE_string("model_config_path", default="downloads/xlnet_cased_L-12_H-768_A-12/xlnet_config.json",
...
flags.DEFINE_string("init_checkpoint", default="downloads/xlnet_cased_L-12_H-768_A-12/xlnet_model.ckpt",
      help="checkpoint path for initializing the model. "
      "Could be a pretrained model or a finetuned model.")
flags.DEFINE_string("output_dir", default="./proc_data/race",
      help="Output dir for TF records.")
flags.DEFINE_string("spiece_model_file", default="downloads/xlnet_cased_L-12_H-768_A-12/spiece.model",
      help="Sentence Piece model path.")
flags.DEFINE_string("model_dir", default="./models/exp/race",
      help="Directory for saving the finetuned model.")
flags.DEFINE_string("data_dir", default="./data/RACE",
